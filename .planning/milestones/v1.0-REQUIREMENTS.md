...
- **PREV-10**: Live browser companion with GitHub-accurate rendering, synced via local WebSocket. Editable in both terminal and browser. Only available when not on SSH.
- **PREV-11**: Browser window opens alongside terminal showing exact GitHub-flavored rendering with live sync as user types
